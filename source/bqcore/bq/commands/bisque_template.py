...
class ServiceTemplate(BisqueTemplate):
    _template_dir = pkg_resources.resource_filename("bq.commands.templates", "service")
...
class CoreServiceTemplate(BisqueTemplate):
    _template_dir = pkg_resources.resource_filename(
        "bq.commands.templates", "core_service"
    )
...
class ModuleTemplate(BisqueTemplate):
    _template_dir = pkg_resources.resource_filename("bq.commands.templates", "module")
